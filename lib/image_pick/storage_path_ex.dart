...
import 'package:flutterbasicc/image_pick/file.dart';
import 'package:storage_path/storage_path.dart';
//import 'package:storage_path_example/file_model.dart';

void main() => runApp(StoragePathEx());

class StoragePathEx extends StatefulWidget {
  @override
  _StoragePathExState createState() => _StoragePathExState();
}

class _StoragePathExState extends State<StoragePathEx> {
  String imagePath = "";
  @override
  void initState() {
    super.initState();
